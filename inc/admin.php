<?php
class Virtual_Robots_Txt_Admin extends Base_Plugin {
	const FIlE_SPEC     = __FILE__;
	const ADMIN_TITLE   = 'Virtual Robots.txt';
	...
	public function settings_page() {
			...
			$output .= '<p>You can <a href="' . $address . '/robots.txt" target="_blank" onclick="window.open(\'' . $address;
